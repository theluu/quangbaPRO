<template>
  ...
  <section class="section-design-web-faq section-pad bg-grey-1">
    <div class="container">
      <SectionTitle :headingTitle="headingSection.headingTitle" :subTitle="headingSection.subTitle" lineBottom />
      <div class="faq-container">
        <div class="faq-list">
          <div class="faq-item" v-for="faq in leftItems" :key="faq.id">
            <div class="faq-question" :class="{ active: activeId === faq.id }" @click="toggleFaq(faq.id)">
              <div class="faq-icon">
          ...
          <div class="faq-button">
            <RouterLink class="btn btn-custom text-primary-color ps-0" to="#">Xem thêm <i
                class="fa-solid fa-arrow-right ms-1"></i></RouterLink>
          </div>
        </div>
      </div>
    </div>
